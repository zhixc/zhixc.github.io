...
### 影音播放
TVBox
- 由猫影视作者联合其他大佬搞的初代，已经删库，目前仍存在且好用的是俊哥的版本：[q215613905/TVBoxOS](https://github.com/q215613905/TVBoxOS)
- 打包好可用的apk，[发布地址](https://github.com/o0HalfLife0o/TVBoxOSC/releases/tag/20230902-0114)
  - [TVBox_q215613905_20230902-0114.apk 加速下载](https://ghproxy.cc/https://github.com/o0HalfLife0o/TVBoxOSC/releases/download/20230902-0114/TVBox_q215613905_20230902-0114.apk)
...
- 推荐使用的版本：v1.7.3、v1.8.0、v2.0.2、v2.0.3、v2.0.8、v2.2.0
- 切勿使用的版本：v2.2.3~v2.9.6，v2.2.3~v2.5.8 由 okjack 改动，新增了很多我认为没用的内容，
- 也带来了很多导致软件闪退的bug，播放器被改动后，电视安卓7播放720p的m3u8都卡顿，这就很离谱了，用老版本v1.7.3播放同一个m3u8流畅多了...
- v2.9.5是fongmi继续更新的版本，试用了一下，发现自动换源功能出问题了，影片没有剧集时不会自动换源，而是播放器一直转圈圈
- [v1.7.3 加速下载](https://ghproxy.cc/https://raw.githubusercontent.com/95369149/TV/main/release/leanback-java.apk)
- [v1.8.2 加速下载](https://ghproxy.cc/https://raw.githubusercontent.com/zhixc/FongMi-TV/main/release/leanback-java-armeabi_v7a.apk)
- [v2.0.3 加速下载](https://ghproxy.cc/https://raw.githubusercontent.com/saxh28/TV/release/release/leanback-java-armeabi_v7a.apk)
