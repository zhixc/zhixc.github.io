...
- 支持 yml / yaml 等订阅
- v0.8.84，要求 安卓 5.0 以上，macOS 10.14 可用，win10 可用，[发布地址](https://github.com/chen08209/FlClash/releases/tag/v0.8.84)
  - [安卓版 FlClash-0.8.84-android-armeabi-v7a.apk 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-android-armeabi-v7a.apk)
  - [安卓版 FlClash-0.8.84-android-armeabi-v7a.apk 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-android-armeabi-v7a.apk)
  - [安卓版 FlClash-0.8.84-android-arm64-v8a.apk 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-android-arm64-v8a.apk)
  - [安卓版 FlClash-0.8.84-android-arm64-v8a.apk 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-android-arm64-v8a.apk)
  - [macOS版 intel cpu 版 FlClash-0.8.84-macos-amd64.dmg 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-macos-amd64.dmg)
  - [macOS版 intel cpu 版 FlClash-0.8.84-macos-amd64.dmg 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-macos-amd64.dmg)
  - [macOS版 M 芯片 arm 架构版 FlClash-0.8.84-macos-arm64.dmg 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-macos-arm64.dmg)
  - [macOS版 M 芯片 arm 架构版 FlClash-0.8.84-macos-arm64.dmg 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-macos-arm64.dmg)
  - [windows版 FlClash-0.8.84-windows-amd64-setup.exe 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-windows-amd64-setup.exe)
  - [windows版 FlClash-0.8.84-windows-amd64-setup.exe 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-windows-amd64-setup.exe)
  - [windows版 FlClash-0.8.84-windows-amd64.zip 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-windows-amd64.zip)
  - [windows版 FlClash-0.8.84-windows-amd64.zip 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.84/FlClash-0.8.84-windows-amd64.zip)
