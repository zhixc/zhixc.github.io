...
- 支持 yml / yaml 等订阅
- v0.8.79，要求 安卓 5.0 以上，macOS 10.14 可用，win10 可用，[发布地址](https://github.com/chen08209/FlClash/releases/tag/v0.8.79)
  - [安卓版 FlClash-0.8.79-android-armeabi-v7a.apk 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-android-armeabi-v7a.apk)
  - [安卓版 FlClash-0.8.79-android-armeabi-v7a.apk 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-android-armeabi-v7a.apk)
  - [安卓版 FlClash-0.8.79-android-arm64-v8a.apk 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-android-arm64-v8a.apk)
  - [安卓版 FlClash-0.8.79-android-arm64-v8a.apk 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-android-arm64-v8a.apk)
  - [macOS版 intel cpu 版 FlClash-0.8.79-macos-amd64.dmg 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-macos-amd64.dmg)
  - [macOS版 intel cpu 版 FlClash-0.8.79-macos-amd64.dmg 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-macos-amd64.dmg)
  - [macOS版 M 芯片 arm 架构版 FlClash-0.8.79-macos-arm64.dmg 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-macos-arm64.dmg)
  - [macOS版 M 芯片 arm 架构版 FlClash-0.8.79-macos-arm64.dmg 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-macos-arm64.dmg)
  - [windows版 FlClash-0.8.79-windows-amd64-setup.exe 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-windows-amd64-setup.exe)
  - [windows版 FlClash-0.8.79-windows-amd64-setup.exe 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-windows-amd64-setup.exe)
  - [windows版 FlClash-0.8.79-windows-amd64.zip 下载](https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-windows-amd64.zip)
  - [windows版 FlClash-0.8.79-windows-amd64.zip 加速下载](https://ghproxy.cc/https://github.com/chen08209/FlClash/releases/download/v0.8.79/FlClash-0.8.79-windows-amd64.zip)

[ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid)
- 支持 yml / yaml 等订阅
- 遇到无法导入的 yaml 文件时或导入后启动异常，可以尝试用订阅转换将 yaml 订阅转成 V2ray 订阅，
订阅转换网站：[https://acl4ssr-sub.github.io/](https://acl4ssr-sub.github.io/)
- v2.11.6，要求安卓5以上
